<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home_Page.aspx.cs" Inherits="Store_Fashion.Home_Page" %>
  ...
  <div class="w3-row w3-grayscale">
    <div class="w3-col l3 s6">
      <div class="w3-container">
        <img src="/img/jeans1.jpg" style="width:100%">
        <p>Ripped Skinny Jeans<br><b>550000</b></p>
      </div>
      <div class="w3-container">
        <img src="/img/jeans2.jpg" style="width:100%">
        <p>Mega Ripped Jeans<br><b>400000</b></p>
      </div>
    </div>
    ...
    <div class="w3-col l3 s6">
      ...
      <div class="w3-container">
        <img src="/img/jeans3.jpg" style="width:100%">
        <p>Washed Skinny Jeans<br><b>370000</b></p>
      </div>
    </div>
    ...
    <div class="w3-col l3 s6">
      <div class="w3-container">
        <img src="/img/jeans3.jpg" style="width:100%">
        <p>Washed Skinny Jeans<br><b>420000</b></p>
      </div>
      <div class="w3-container">
        <div class="w3-display-container">
          <img src="/img/jeans4.jpg" style="width:100%">
          <span class="w3-tag w3-display-topleft">Sale</span>
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-black">Buy now <i class="fa fa-shopping-cart"></i></button>
          </div>
        </div>
        <p>Vintage Skinny Jeans<br><b class="w3-text-red">390000</b></p>
      </div>
    </div>
    ...
    <div class="w3-col l3 s6">
      <div class="w3-container">
        <img src="/img/jeans4.jpg" style="width:100%">
        <p>Vintage Skinny Jeans<br><b>320000</b></p>
      </div>
      <div class="w3-container">
        <img src="/img/jeans1.jpg" style="width:100%">
        <p>Ripped Skinny Jeans<br><b>$550000</b></p>

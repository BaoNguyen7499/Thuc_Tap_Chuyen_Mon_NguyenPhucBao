<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dresses.aspx.cs" Inherits="Store_Fashion.Dresses" %>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-display-container w3-container">
    <img src="/img/dresses.jpg" alt="Dresses" style="width:100%">
  ...
  <div class="w3-row w3-grayscale">
    <div class="w3-col l3 s6">
      <div class="w3-container">
        <img src="/img/dresses1.jpg" style="width:100%">
        <p>Dresses anime<br><b>550000</b></p>
      </div>
      <div class="w3-container">
        <img src="/img/dresses2.jpg" style="width:100%">
        <p>Dresses anime<br><b>400000</b></p>
      </div>
    </div>
    ...
    <div class="w3-col l3 s6">
      <div class="w3-container">
        <div class="w3-display-container">
          <img src="/img/dresses3.jpg" style="width:100%">
          <span class="w3-tag w3-display-topleft">New</span>
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-black">Buy now <i class="fa fa-shopping-cart"></i></button>
          </div>
        </div>
        <p>Dresses anime<br><b>540000</b></p>
      </div>
      <div class="w3-container">
        <img src="/img/dresses4.jpg" style="width:100%">
        <p>Dresses anime<br><b>370000</b></p>
      </div>
    </div>

    <div class="w3-col l3 s6">
      <div class="w3-container">
        <img src="/img/dresses5.jpg" style="width:100%">
        <p>Dresses anime<br><b>420000</b></p>
      </div>
      <div class="w3-container">
        <div class="w3-display-container">
          <img src="/img/dresses6.jpg" style="width:100%">
          <span class="w3-tag w3-display-topleft">Sale</span>
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-black">Buy now <i class="fa fa-shopping-cart"></i></button>
          </div>
        </div>
        <p>Dresses anime<br><b class="w3-text-red">390000</b></p>
      </div>
    </div>

    <div class="w3-col l3 s6">
      <div class="w3-container">
        <img src="/img/dresses7.jpg" style="width:100%">
        <p>Dresses Anime<br><b>320000</b></p>
      </div>
      <div class="w3-container">
        <img src="/img/dresses8.jpg" style="width:100%">
        <p>Dresses anime<br><b>$550000</b></p>
      </div>
    </div>
  </div>
